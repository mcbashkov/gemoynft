          ...
          <div className="row">
            <div className="col-lg-6">
              ...
              >
                ...
                <h2 className="title">Koleksi Ragam NFT GEMOY</h2>
                <p className="desc">
                Jadilah bagian dari komunitas dan kolektor project NFT berbasis pendukung calon Presiden dan Wakil Presiden RI 2024 yang Gemoy/Menggemaskan namun kongkrit dalam memajukan Blockchain di Indonesia.
                </p>
                <a
                  ...
                  >
                    ...
                    <text fontSize="11.75">
                      <textPath xlinkHref="#circle">
                        lihat di opensea • lihat di Opensea •
                      </textPath>
                    </text>
                  </svg>
